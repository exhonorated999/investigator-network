...
-- CreateIndex
CREATE INDEX "Post_topic_hidden_createdAt_idx" ON "Post"("topic", "hidden", "createdAt");
...
-- AddForeignKey
ALTER TABLE "PostReaction" ADD CONSTRAINT "PostReaction_commentId_fkey" FOREIGN KEY ("commentId") REFERENCES "PostComment"("id") ON DELETE CASCADE ON UPDATE CASCADE;
